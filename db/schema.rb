...
ActiveRecord::Schema.define(:version => 20140504172516) do
  ...
  create_table "teaching_assistant_assignments", :force => true do |t|
    t.integer  "user_id"
    t.integer  "course_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  add_index "teaching_assistant_assignments", ["course_id"], :name => "index_teaching_assistant_assignments_on_course_id"
  add_index "teaching_assistant_assignments", ["user_id"], :name => "index_teaching_assistant_assignments_on_user_id"
